    ...
    <section className="relative overflow-hidden bg-porcelain py-24 md:py-36">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center md:px-12">
        ...
        <h2 className="mt-6 font-display text-5xl leading-[1.05] text-ink md:text-7xl">
          ...
          <TextReveal delay={0.12} className="justify-center italic text-gold-deep">
            sourcing conversation.
          </TextReveal>
        </h2>
        <Reveal delay={0.24}>
          <p className="mx-auto mt-8 max-w-xl text-base leading-relaxed text-ink/60">
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-5 sm:flex-row">
            <Magnetic>
              <a
                ...
                data-cursor="Email"
                className="group flex items-center gap-2 rounded-full bg-ink px-9 py-4 text-xs uppercase tracking-[0.2em] text-porcelain transition hover:bg-gold-deep"
              >
                Book an Appointment
                <ArrowUpRight
                  size={14}
            ...
            <a
              ...
              className="text-xs uppercase tracking-[0.2em] text-ink/60 transition hover:text-gold-deep"
            >
              +91 141 451 7725
            </a>
          </div>
